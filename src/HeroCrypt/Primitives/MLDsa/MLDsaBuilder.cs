...
public class MLDsaBuilder : IDisposable
{
    ...
    public MLDsaBuilder WithSecurityLevel(MLDsaCore.SecurityLevel level)
    {
        securityLevel = level;
        return this;
    }
    ...
    {
        securityLevel = MLDsaCore.GetRecommendedLevel(securityBits);
        return this;
    }
    ...
    public MLDsaBuilder WithKeyPair(MLDsaCore.MLDsaKeyPair keyPair)
    {
#if !NETSTANDARD2_0
    ...
    {
        return MLDsaCore.GetLevelInfo(securityLevel);
    }
