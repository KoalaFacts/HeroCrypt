...
public class SlhDsaBuilder : IDisposable
{
    ...
    public SlhDsaBuilder WithSecurityLevel(SlhDsaCore.SecurityLevel level)
    {
        securityLevel = level;
        return this;
    }
    ...
    {
        securityLevel = SlhDsaCore.GetRecommendedLevel(securityBits, preferSmall);
        return this;
    }
    ...
    public SlhDsaBuilder WithKeyPair(SlhDsaCore.SlhDsaKeyPair keyPair)
    {
#if !NETSTANDARD2_0
    ...
    {
        return SlhDsaCore.GetLevelInfo(securityLevel);
    }
