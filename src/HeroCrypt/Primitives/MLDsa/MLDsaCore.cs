...
/// </para>
/// <para><b>Standard:</b> NIST FIPS 204</para>
/// <para><b>Security Basis:</b> MLWE and MSIS hardness assumptions</para>
...
/// </list>
/// <para>
/// Always check <see cref="IsSupported"/> before using ML-DSA operations to ensure
...
public static class MLDsaCore
{
    ...
    public sealed class MLDsaKeyPair : IDisposable
    {
        ...
        internal MLDsaKeyPair(SystemMLDsa key, SecurityLevel level)
        {
    ...
    public static MLDsaKeyPair GenerateKeyPair(SecurityLevel level = SecurityLevel.MLDsa65)
    {
        ...
        var key = SystemMLDsa.GenerateKey(algorithm);
    ...
    public static byte[] Sign(string privateKeyPem, byte[] data, int securityBits, byte[]? context = null)
    {
        ...
        using var key = SystemMLDsa.ImportFromPem(privateKeyPem);
    ...
    public static bool Verify(string publicKeyPem, byte[] data, byte[] signature, byte[]? context = null)
    {
        ...
        using var key = SystemMLDsa.ImportFromPem(publicKeyPem);
    ...
    public static SystemMLDsa ImportPublicKey(string publicKeyPem)
    {
        ...
        return SystemMLDsa.ImportFromPem(publicKeyPem);
    }
