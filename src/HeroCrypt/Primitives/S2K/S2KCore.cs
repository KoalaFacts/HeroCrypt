...
internal static class S2KCore
{
    ...
    /// <summary>
    /// Generates a random salt for S2K operations.
    /// </summary>
    ...
    private static byte[] HashData(byte[] data, HashAlgorithmName hashAlgorithm)
    {
        ...
        throw new ArgumentException($"Unsupported hash algorithm: {hashAlgorithm}. Use SHA256, SHA384, or SHA512.", nameof(hashAlgorithm));
    }
