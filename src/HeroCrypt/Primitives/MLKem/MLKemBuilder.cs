...
namespace HeroCrypt.Primitives.MLKem;
...
public class MLKemBuilder : IDisposable
{
    ...
    public MLKemBuilder WithSecurityLevel(MLKemCore.SecurityLevel level)
    {
        securityLevel = level;
        return this;
    }
    ...
    {
        securityLevel = MLKemCore.GetRecommendedLevel(securityBits);
        return this;
    }
    ...
    public MLKemBuilder WithKeyPair(MLKemCore.MLKemKeyPair keyPair)
    {
#if !NETSTANDARD2_0
    ...
    public MLKemCore.EncapsulationResult Encapsulate()
    {
        if (publicKeyPem == null)
        {
    ...
    {
        return MLKemCore.GetLevelInfo(securityLevel);
    }
