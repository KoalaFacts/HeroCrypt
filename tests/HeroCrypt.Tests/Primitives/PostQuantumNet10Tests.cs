...
{
    /// <summary>
    /// Tests for ML-KEM (Module-Lattice Key Encapsulation Mechanism).
    /// </summary>
    public class MLKemTests
    {
        ...
        [Fact]
        public void GetRecommendedLevel_ReturnsCorrectLevel()
        {
    ...
    /// <summary>
    /// Tests for ML-DSA (Module-Lattice Digital Signature Algorithm).
    /// </summary>
    ...
    /// <summary>
    /// Tests for SLH-DSA (Stateless Hash-Based Digital Signature Algorithm).
    /// </summary>
    ...
    /// <summary>
    /// Integration tests combining multiple PQC algorithms.
    /// </summary>
    ...
    /// <summary>
    /// Tests for the unified HeroCryptBuilder API with PQC algorithms.
    /// </summary>
    public class UnifiedHeroCryptBuilderTests
    {
        [Fact]
    ...
    /// <summary>
    /// Tests for the builder pattern fluent API.
    /// </summary>
