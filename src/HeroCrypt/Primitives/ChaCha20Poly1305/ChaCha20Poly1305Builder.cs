...
/// <summary>
/// Fluent builder for ChaCha20-Poly1305 AEAD encryption operations.
/// Provides authenticated encryption according to RFC 8439.
/// </summary>
/// <example>
/// <code>
/// // Encrypt data
/// using var builder = ChaCha20Poly1305Builder.Create()
///     .WithKey(key)
///     .WithNonce(nonce)
...
///
/// // Decrypt data
/// using var decryptor = ChaCha20Poly1305Builder.Create()
///     .WithKey(key)
///     .WithNonce(nonce)
///     .WithAssociatedData(aad);
...
/// </code>
/// </example>
public sealed class ChaCha20Poly1305Builder : IDisposable
{
    ...
    public static ChaCha20Poly1305Builder Create() => new();
    ...
    public ChaCha20Poly1305Builder WithKey(byte[] key)
    {
    ...
    /// <param name="key">The 32-byte encryption key.</param>
    /// <returns>The builder instance for method chaining.</returns>
    public ChaCha20Poly1305Builder WithKey(ReadOnlySpan<byte> key)
    {
        ClearKey();
    ...
    public ChaCha20Poly1305Builder WithNonce(byte[] nonce)
    {
    ...
    /// <param name="nonce">The 12-byte nonce.</param>
    /// <returns>The builder instance for method chaining.</returns>
    public ChaCha20Poly1305Builder WithNonce(ReadOnlySpan<byte> nonce)
    {
        ClearNonce();
    ...
    /// </summary>
    /// <returns>The builder instance for method chaining.</returns>
    public ChaCha20Poly1305Builder WithRandomNonce()
    {
        ClearNonce();
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public ChaCha20Poly1305Builder WithAssociatedData(byte[]? associatedData)
    {
        ClearAssociatedData();
    ...
    /// <param name="associatedData">The associated data to authenticate (not encrypted).</param>
    /// <returns>The builder instance for method chaining.</returns>
    public ChaCha20Poly1305Builder WithAssociatedData(ReadOnlySpan<byte> associatedData)
    {
        ClearAssociatedData();
