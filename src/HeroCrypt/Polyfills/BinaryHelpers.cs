...
internal static class BinaryHelpers
{
    ...
    /// <summary>
    /// Writes a 64-bit unsigned integer in little-endian format to a span at the specified offset.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteUInt64LittleEndian(Span<byte> destination, int offset, ulong value)
    {
    ...
    /// <summary>
    /// Reads a 64-bit unsigned integer in little-endian format from a span at the specified offset.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ulong ReadUInt64LittleEndian(ReadOnlySpan<byte> source, int offset)
    {
    ...
    /// <summary>
    /// Writes a 32-bit unsigned integer in little-endian format to a span at the specified offset.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    /// Writes a 32-bit signed integer in little-endian format to a span at the specified offset.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteInt32LittleEndian(Span<byte> destination, int offset, int value)
    {
    ...
    /// <summary>
    /// Reads a 32-bit unsigned integer in little-endian format from a span at the specified offset.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
