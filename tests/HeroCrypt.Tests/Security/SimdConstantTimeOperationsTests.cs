...
{
    /// <summary>
    /// Tests for ConstantTimeArrayEquals method with various array sizes.
    /// </summary>
    [Trait("Category", TestCategories.UNIT)]
    [Trait("Category", TestCategories.SECURITY)]
    public class ConstantTimeArrayEqualsTests
    {
        [Fact]
        public void EmptyArrays_ReturnsTrue()
        {
        ...
        [InlineData(100)]
        [InlineData(256)]
        public void EqualArrays_ReturnsTrue(int size)
        {
            var a = new byte[size];
            var b = new byte[size];
        ...
        public void DifferentArrays_ReturnsFalse(int size, int diffPosition)
        {
            var a = new byte[size];
            var b = new byte[size];
        ...
        [Fact]
        public void AllZeros_ReturnsTrue()
        {
            var a = new byte[64];
            var b = new byte[64];
        ...
        [Fact]
        public void AllOnes_ReturnsTrue()
        {
    ...
    /// <summary>
    /// Tests for ConditionalCopy method.
    /// </summary>
    [Trait("Category", TestCategories.UNIT)]
    [Trait("Category", TestCategories.SECURITY)]
    ...
    {
        [Fact]
        public void ConditionOne_CopiesData()
        {
        ...
        [Fact]
        public void ConditionZero_DoesNotCopy()
        {
            var source = new byte[] { 1, 2, 3, 4, 5 };
            var destination = new byte[] { 10, 20, 30, 40, 50 };
        ...
        [InlineData(64)]
        [InlineData(100)]
        public void ConditionOne_VariousSizes_CopiesData(int size)
        {
        ...
        [InlineData(48)]
        [InlineData(64)]
        public void ConditionZero_VariousSizes_PreservesDestination(int size)
        {
            var source = new byte[size];
            var destination = new byte[size];
        ...
        [Fact]
        public void PartialLength_OnlyCopiesSpecifiedBytes()
        {
            var source = new byte[] { 1, 2, 3, 4, 5 };
            var destination = new byte[] { 10, 20, 30, 40, 50 };
        ...
        [Fact]
        public void ConditionNormalized_TreatsNonZeroAsOne()
        {
            var source = new byte[] { 1, 2, 3, 4, 5 };
            var destination = new byte[] { 10, 20, 30, 40, 50 };
    ...
    /// <summary>
    /// Parameter validation tests for ConditionalCopy.
    /// </summary>
    [Trait("Category", TestCategories.UNIT)]
    [Trait("Category", TestCategories.EDGE_CASE)]
    public class ConditionalCopyParameterValidationTests
    {
        [Fact]
        public void NegativeLength_ThrowsArgumentException()
        {
        ...
        [Fact]
        public void LengthExceedsSource_ThrowsArgumentException()
        {
            var source = new byte[] { 1, 2, 3 };
    ...
    /// <summary>
    /// Tests for SecureClear method.
    /// </summary>
    [Trait("Category", TestCategories.UNIT)]
    [Trait("Category", TestCategories.MEMORY)]
    public class SecureClearTests
    {
        [Fact]
        public void EmptySpan_DoesNotThrow()
        {
        ...
        [InlineData(64)]
        [InlineData(100)]
        public void VariousSizes_ClearsAllBytes(int size)
        {
        ...
        [Fact]
        public void AlreadyZero_RemainsZero()
        {
    ...
    /// <summary>
    /// Tests for XorArrays method.
    /// </summary>
    [Trait("Category", TestCategories.UNIT)]
    public class XorArraysTests
    {
        [Fact]
        public void EmptyArrays_DoesNotThrow()
        {
            var a = Array.Empty<byte>();
            var b = Array.Empty<byte>();
        ...
        [InlineData(64)]
        [InlineData(100)]
        public void VariousSizes_ComputesCorrectXor(int size)
        {
            var a = new byte[size];
            var b = new byte[size];
        ...
        [Fact]
        public void SameArray_ProducesZeros()
        {
        ...
        [Fact]
        public void WithZeros_ReturnsOtherArray()
        {
            var a = new byte[] { 1, 2, 3, 4, 5 };
        ...
        [Fact]
        public void InPlace_WorksCorrectly()
        {
            var a = new byte[] { 1, 2, 3, 4, 5 };
    ...
    /// <summary>
    /// Parameter validation tests for XorArrays.
    /// </summary>
    [Trait("Category", TestCategories.UNIT)]
    [Trait("Category", TestCategories.EDGE_CASE)]
    public class XorArraysParameterValidationTests
    {
        [Fact]
        public void DifferentLengths_ThrowsArgumentException()
        {
            var a = new byte[] { 1, 2, 3 };
            var b = new byte[] { 1, 2, 3, 4 };
    ...
    /// <summary>
    /// Tests for IsAvailable property.
    /// </summary>
    [Trait("Category", TestCategories.UNIT)]
    ...
    public class RegressionTests
    {
        ...
        /// </summary>
        [Fact]
        public void ConditionalCopy_FallbackActuallyModifiesDestination()
        {
        ...
        public void ConstantTimeArrayEquals_DetectsDifferenceInSse2Range(int size)
        {
            var a = new byte[size];
            var b = new byte[size];
        ...
        /// </summary>
        [Fact]
        public void ConstantTimeArrayEquals_DifferenceAtByte40_Detected()
        {
            var a = new byte[48];
            var b = new byte[48];
