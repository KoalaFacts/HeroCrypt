...
{
    /// <summary>
    /// Tests for hybrid encryption combining ML-KEM key encapsulation with AES-GCM.
    /// </summary>
    ...
    /// <summary>
    /// Tests for digital signature workflows using ML-DSA.
    /// </summary>
    public class DigitalSignatureWorkflows
    {
        [Fact]
    ...
    /// <summary>
    /// Tests for hash-based signatures using SLH-DSA.
    /// </summary>
    public class HashBasedSignatures
    {
        [Fact]
    ...
    /// <summary>
    /// Tests for key management operations including rotation and export/import.
    /// </summary>
    ...
    /// <summary>
    /// Performance and stress tests for PQC operations.
    /// </summary>
    public class PerformanceAndStress
    {
        [Fact]
    ...
    /// <summary>
    /// Tests for validating all PQC security parameter sets.
    /// </summary>
    public class SecurityParameterValidation
    {
        [Fact]
    ...
    /// <summary>
    /// Real-world scenario tests demonstrating practical PQC applications.
    /// </summary>
